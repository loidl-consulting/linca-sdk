...
internal class US013_SteinmaierPrescribeSimvastatin : Spec
{
    ...
    public US013_SteinmaierPrescribeSimvastatin(LincaConnection conn) : base(conn) 
    {
        Steps = new Step[]
            {
    ...
    private bool CreatePrescriptionRecord()
    {
        ...
        if (received)
        {
            ...
            MedicationRequest? orderProposalSimvastatin = proposalsToPrescribe.Find(x => x.Subject.Display.Contains("Steinmaier"));
            //MedicationRequest? orderProposalSimvastatin = proposalsToPrescribe.Find(x => x.Id.Equals("   "));  // ENTER ID STRING HERE
            
            if (orderProposalSimvastatin == null)
            {
            ...
            {
                Reference = $"LINCAProposalMedicationRequest/{orderProposalSimvastatin.Id}"
            });
            ...
            prescription.Subject = orderProposalSimvastatin!.Subject;
            prescription.Medication = orderProposalSimvastatin!.Medication;
            /*
