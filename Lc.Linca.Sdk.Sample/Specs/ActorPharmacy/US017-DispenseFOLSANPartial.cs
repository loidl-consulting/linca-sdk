...
internal class US017_DispenseFolsanPartial : Spec
{
    ...
    public US017_DispenseFolsanPartial(LincaConnection conn) : base(conn)
    {
        Steps = new Step[]
        {
        ...
        if (received)
        {
            ...
            */
            ...
            dispense1.Type = new()
            {
                Coding = new()
                {
                    new Coding(system: "http://terminology.hl7.org/CodeSystem/v3-ActCode", code: "FFP") // partial dispense
                }
            };
