...
internal class US023_MedOrderMagistralium : Spec
{
    public const string UserStory = @"
        Employee 1276 at the mobile caregiver organization Haus Vogelsang, 
        whose client, Klient 2, is already in the LINCA system, orders medication without PZN for him. 
        The employee also specifies his preferred pharmacy for pick-up.";

    protected MedicationRequest medReq = new();

    public US023_MedOrderMagistralium(LincaConnection conn) : base(conn)
    {
        Steps = new Step[]
        {
            new("Place order for magistralium", CreateRequestOrchestrationRecord)
        };
    }
